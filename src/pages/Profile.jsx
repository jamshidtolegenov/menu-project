          ...
          <div className="preference-list">
            ...
            <div className="preference-item">
              <div className="preference-info">
                <span className="preference-icon">📧</span>
                <div>
                  <p className="preference-name">Email рассылка</p>
                  <p className="preference-desc">Акции и специальные предложения</p>
                </div>
              </div>
              <label className="toggle-switch">
                <input 
            ...
            <div className="preference-item">
              <div className="preference-info">
                ...
                <div>
                  ...
                  <p className="preference-desc">Включить темное оформление</p>
                </div>
              </div>
              <label className="toggle-switch">
                <input 
